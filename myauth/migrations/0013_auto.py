...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'myauth_user_interests')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'myauth.user'], null=False)),
            ('interest', models.ForeignKey(orm[u'myauth.interest'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'myauth_user_interests'))
    ...
    models = {
        ...
        u'myauth.registration': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a723a583-1449-4e6a-8240-f87e72366519'", 'max_length': '36'})
        },
        u'myauth.user': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interests': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['myauth.Interest']", 'symmetrical': 'False'}),

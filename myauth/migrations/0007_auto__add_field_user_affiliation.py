...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'myauth_user', 'affiliation',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'myauth_user', 'affiliation')
    ...
    models = {
        ...
        u'myauth.registration': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'13c2138c-25c0-44a8-a669-d63d79872567'", 'max_length': '36'})
        },
        u'myauth.user': {

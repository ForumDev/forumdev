...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.accept_terms'
        db.add_column(u'myauth_user', 'accept_terms',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.accept_terms'
        db.delete_column(u'myauth_user', 'accept_terms')
    ...
    models = {
        ...
        u'myauth.registration': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'aec63588-1695-4109-bad1-322c55b5418c'", 'max_length': '36'})
        },
        u'myauth.user': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'myauth_user', 'telephone',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'myauth_user', 'telephone')
    ...
    models = {
        ...
        u'myauth.registration': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d8bec4df-56ba-4bc8-bda0-e9effe48985b'", 'max_length': '36'})
        },
        u'myauth.user': {

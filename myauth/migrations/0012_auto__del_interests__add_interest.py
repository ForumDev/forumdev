...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'myauth_interests')

        # Adding model 'Interest'
        db.create_table(u'myauth_interest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
        ))
        db.send_create_signal(u'myauth', ['Interest'])


    def backwards(self, orm):
        # Adding model 'Interests'
        db.create_table(u'myauth_interests', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
        ))
        db.send_create_signal(u'myauth', ['Interests'])

        # Deleting model 'Interest'
        db.delete_table(u'myauth_interest')
    ...
    models = {
        ...
        u'myauth.registration': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c178e08c-65c7-4d09-969d-e13a89f313aa'", 'max_length': '36'})
        },
        u'myauth.user': {

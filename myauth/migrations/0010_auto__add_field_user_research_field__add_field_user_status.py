...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.research_field'
        db.add_column(u'myauth_user', 'research_field',
    ...
    def backwards(self, orm):
        # Deleting field 'User.research_field'
        db.delete_column(u'myauth_user', 'research_field')
    ...
    models = {
        ...
        u'myauth.registration': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'614a3536-4270-40a1-a53e-67e9e1b73a83'", 'max_length': '36'})
        },
        u'myauth.user': {

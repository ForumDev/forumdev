...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.google_scholar'
        db.add_column(u'myauth_user', 'google_scholar',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.orcid_id'
        db.add_column(u'myauth_user', 'orcid_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.google_scholar'
        db.delete_column(u'myauth_user', 'google_scholar')

        # Deleting field 'User.orcid_id'
        db.delete_column(u'myauth_user', 'orcid_id')
    ...
    models = {
        ...
        u'myauth.registration': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a6390e5f-e7e2-4447-ae63-4b246862345b'", 'max_length': '36'})
        },
        u'myauth.user': {
            ...
            'publication_feed': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'myauth_user', 'status')

        # Adding field 'User.research_status'
        db.add_column(u'myauth_user', 'research_status',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'myauth_user', 'status',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'User.research_status'
        db.delete_column(u'myauth_user', 'research_status')
    ...
    models = {
        ...
        u'myauth.registration': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 18, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'192aec02-bd5e-4d61-92c6-57107b1d51d2'", 'max_length': '36'})
        },
        u'myauth.user': {

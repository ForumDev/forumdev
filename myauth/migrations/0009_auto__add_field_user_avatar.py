...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'myauth_user', 'avatar',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'myauth_user', 'avatar')
    ...
    models = {
        ...
        u'myauth.registration': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8b14c3cc-8a1b-4542-bb34-1f5b4b75f2d3'", 'max_length': '36'})
        },
        u'myauth.user': {

...
from myauth.views import LoginView, LogoutView, RegisterView, ProfileView, EmailSentView, ActivationView, LostPasswordView, LostPasswordEmailSentView, LostPasswordChangeView

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'categories', ['SubCat'])

        # Adding model 'CatSel'
        db.create_table(u'categories_catsel', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('cat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Category'])),
        ))
        db.send_create_signal(u'categories', ['CatSel'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SubCat'
        db.delete_table(u'categories_subcat')

        # Deleting model 'CatSel'
        db.delete_table(u'categories_catsel')
    ...
    models = {
        ...
        u'categories.catsel': {
            'Meta': {'object_name': 'CatSel', '_ormbases': ['cms.CMSPlugin']},
